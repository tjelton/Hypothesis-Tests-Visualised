      ...
      tabItem(tabName = "1_sample_t_test",
              ...
              fluidRow(
                ...
                column(4,
                       ...
                       tags$style(HTML(paste0("
                        ...
                        "))),
                       actionButton("learning_text", "What is a 1-sample t-test?", class = "btn btn-primary", style="color: #fff;", width = "100%")
                ),
              ),
              HTML("<br>"),
              
              ############ SECTION: Input Data ############
              load_1_sample_data_UI("loading_data", test_name = "1-sample t-test"),
              ...
              conditionalPanel(
                ...
                fluidRow(
                  ...
                  column(6,
                         plotOutput("test_stat_t_plot", width = "80%", heigh = "275px"),
                  )
                ),
