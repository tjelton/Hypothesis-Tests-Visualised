...
source("Fundamentals/box_model_part_3_ui.R")
source("Fundamentals/box_model_part_3_srv.R")
source("Fundamentals/confidence_interval_ui.R")
source("Fundamentals/confidence_interval_srv.R")
...
source("t-test/paired_t_test_ui.R")
source("t-test/paired_t_test_srv.R")
source("t-test/2_sample_t_test_ui.R")
source("t-test/2_sample_t_test_srv.R")
source("t-test/regression_t_test_ui.R")
source("t-test/regression_t_test_srv.R")
...
source("t-test/1_sample_t_test_generic_modules/assumptions_srv.R")
...
source("t-test/1_sample_t_test_generic_modules/confidence_interval_ui.R")
source("t-test/1_sample_t_test_generic_modules/confidence_interval_srv.R")
...
source("Utility/load_data_2_sample_ui.R")
source("Utility/load_data_2_sample_srv.R")
source("Utility/load_data_regression_2_variable_ui.R")
source("Utility/load_data_regression_2_variable_srv.R")