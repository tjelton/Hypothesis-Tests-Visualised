...
# then open http://localhost:8000/Chi-Square-Tests/chi-square-goodness-of-fit/
```
...
```sh
osascript -l JavaScript Chi-Square-Tests/chi-square-goodness-of-fit/tests/smoke_jxa.js
```
