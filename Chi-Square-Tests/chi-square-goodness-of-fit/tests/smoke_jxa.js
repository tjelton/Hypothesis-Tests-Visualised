...
function run(argv) {
  ...
  const expected = JSON.parse(readFile("Chi-Square-Tests/chi-square-goodness-of-fit/tests/expected_pipeline.json"));
  ...
  try {
    const appSrc = readFile("Chi-Square-Tests/chi-square-goodness-of-fit/js/app.js");
