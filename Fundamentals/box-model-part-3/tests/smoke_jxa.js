...
function run(argv) {
  ...
  const expected = JSON.parse(readFile("Fundamentals/box-model-part-3/tests/expected_pipeline.json"));
  ...
  try {
    const appSrc = readFile("Fundamentals/box-model-part-3/js/app.js");
