...
function run(argv) {
  ...
  const expected = JSON.parse(readFile("chi-square-test-of-independence/tests/expected_pipeline.json"));
  ...
  try {
    const appSrc = readFile("chi-square-test-of-independence/js/app.js");
